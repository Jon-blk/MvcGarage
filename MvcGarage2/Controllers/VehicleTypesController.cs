...
namespace MvcGarage2.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public VehicleTypesController(MvcGarage2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,ParkingPrice")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,ParkingPrice")] VehicleType vehicleType)
        {
